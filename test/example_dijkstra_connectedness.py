...
tic = timer()
cmap2d.fastmarch(ij[0])
toc = timer()
print("Fastmarch : {} ms".format((toc-tic)*1000))
...
plt.sca(ax4)
gridshow(gridfm, cmap=Greys_c10)
plt.title("FMM")
...
gridfmpath4,  jumps = CMap2D.path_from_dijkstra_field(gridfm, start, connectedness= 4)
gridfmpath8,  jumps = CMap2D.path_from_dijkstra_field(gridfm, start, connectedness= 8)
gridfmpath16, jumps = CMap2D.path_from_dijkstra_field(gridfm, start, connectedness=16)
gridfmpath32, jumps = CMap2D.path_from_dijkstra_field(gridfm, start, connectedness=32)
...
plt.sca(ax4)
gridshow(gridfm, cmap=Greys_c10)
plt.plot(gridfmpath4[:,0],  gridfmpath4[:,1] , '-o', color=plt.cm.winter(  0.) , mec=plt.cm.winter(  0.), mfc=[0,0,0,0])
plt.plot(gridfmpath8[:,0],  gridfmpath8[:,1] , '-o', color=plt.cm.winter(0.33) , mec=plt.cm.winter(0.33), mfc=[0,0,0,0])
plt.plot(gridfmpath16[:,0], gridfmpath16[:,1], '-o', color=plt.cm.winter(0.66) , mec=plt.cm.winter(0.66), mfc=[0,0,0,0])
plt.plot(gridfmpath32[:,0], gridfmpath32[:,1], '-o', color=plt.cm.winter(  1.) , mec=plt.cm.winter(  1.), mfc=[0,0,0,0])
plt.title("FMM")
ax3.legend([ '4-connected', '8-connected', '16-connected', '32-connected'])

# With SDF
extra_costs = 10./(0.0000001+cmap2d.as_sdf())
pextra_costs = 10./cmap2d.as_sdf()
speeds = 1/(1+pextra_costs)
...
gridfm  = cmap2d.fastmarch(ij[0], speeds=speeds)
...
fig, (ax0, ax1, ax2, ax3, ax4) = plt.subplots(1, 5, num="including sdf edge costs")
plt.sca(ax0)
gridshow(grid4, cmap=Greys_c10)
plt.plot(grid4path4[:,0],  grid4path4[:,1] , '-o', color=plt.cm.winter(  0.) , mec=plt.cm.winter(  0.), mfc=[0,0,0,0])
plt.plot(grid4path8[:,0],  grid4path8[:,1] , '-o', color=plt.cm.winter(0.33) , mec=plt.cm.winter(0.33), mfc=[0,0,0,0])
