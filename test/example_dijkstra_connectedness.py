...
toc = timer()
print("Dijsktra 4-connected : {} ms".format((toc-tic)*1000))

tic = timer()
cmap2d.dijkstra(ij[0], inv_value=-1, connectedness=8)
toc = timer()
print("Dijsktra 8-connected : {} ms".format((toc-tic)*1000))
...
toc = timer()
print("Dijkstra descent 4-connected : {} ms".format((toc-tic)*1000))
tic = timer()
CMap2D.path_from_dijkstra_field(pgrid8, start, connectedness= 8)
toc = timer()
print("Dijkstra descent 8-connected : {} ms".format((toc-tic)*1000))
tic = timer()
CMap2D.path_from_dijkstra_field(pgrid16, start, connectedness=16)
toc = timer()
print("Dijkstra descent 16-connected : {} ms".format((toc-tic)*1000))
tic = timer()
