...
repeatgreys_cm = ListedColormap(plt.cm.Greys(np.mod(np.linspace(0., 10., 256), 1.)))
...
plt.sca(ax0)
gridshow(grid4, cmap=repeatgreys_cm)
plt.title("4-connected")
plt.sca(ax1)
gridshow(grid8, cmap=repeatgreys_cm)
plt.title("8-connected")
plt.sca(ax2)
gridshow(grid16, cmap=repeatgreys_cm)
plt.title("16-connected")
plt.sca(ax3)
gridshow(grid32, cmap=repeatgreys_cm)
